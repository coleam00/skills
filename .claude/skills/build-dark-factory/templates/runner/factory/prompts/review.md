...
- **Conventions** (`CLAUDE.md`): threaded state, ticks not seconds, no debug output in the core module,
...
---
issue: {{issue_ref}}
title: <the change, in the imperative, as CLAUDE.md wants a commit subject>
branch: {{branch}}
state: open
attempts: 0
---
